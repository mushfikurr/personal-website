...
const renderMenu = (_) => {
  return (
    <>
      <FadeLink fontSize={"1.05rem"} link="/about" text="about me" />
      <FadeLink fontSize={"1.05rem"} link="/projects" text="projects" />
      <FadeLink fontSize={"1.05rem"} link="/funstuff" text="fun stuff" />
    </>
  );
};
